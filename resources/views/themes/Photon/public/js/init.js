...
(function ($) {
    ...
    skel.init({
        reset: 'full',
        breakpoints: {
            global: {href: 'dashboard/style.css', containers: '60em', grid: {gutters: ['2em', 0]}},
            xlarge: {media: '(max-width: 1680px)', href: 'dashboard/style-xlarge.css'},
            large: {
                media: '(max-width: 1140px)',
                href: 'dashboard/style-large.css',
                containers: '90%',
                grid: {gutters: ['1.5em', 0]}
            },
            medium: {media: '(max-width: 980px)', href: 'dashboard/style-medium.css', containers: '100%!'},
            small: {media: '(max-width: 736px)', href: 'dashboard/style-small.css', viewport: {scalable: false}},
            xsmall: {media: '(max-width: 480px)', href: 'dashboard/style-xsmall.css'},
            xxsmall: {media: '(max-width: 320px)', href: 'dashboard/style-xxsmall.css'}
        }
    });
