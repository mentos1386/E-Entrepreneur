...
<div class="col-md-9">
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            <input type="text" name="data[images][1][btn_custom_url]" class="form-control"
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            <input type="text" name="data[images][2][btn_custom_url]" class="form-control"
                   placeholder="Enter button url">
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            <input type="text" name="data[images][3][btn_custom_url]" class="form-control"
                   placeholder="Enter button url">
...
<div class="col-md-3">
    ...
    <div class="col-md-12">
        <div class="jumbotron">
            ...
            <p>Here you can create new image builder.</p>
